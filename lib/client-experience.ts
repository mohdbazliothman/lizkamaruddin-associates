...
export const clientExperience: ClientExperience[] = [
  ...
  { name: "ANOC Medicare & Diagnostic", logo: "/images/clients/anoc-medicare-diagnostic.png", size: "wide", featured: true },
  ...
  { name: "Ministry of Tourism, Arts and Culture Malaysia", logo: "/images/clients/ministry-of-tourism-arts-and-culture-malaysia.png", size: "wide" }
];
